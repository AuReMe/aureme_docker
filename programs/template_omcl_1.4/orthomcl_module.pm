...
# softwares
our $BLASTALL                            = "/programs/blast-2.2.17/bin/blastall";
...
our $FORMATDB                            = "/programs/blast-2.2.17/bin/formatdb";
our $MCL                                 = "/programs/mcl-02-063/shmcl/mcl";

# path
our $PATH_TO_ORTHOMCL                    = "/programs/template_omcl_1.4/";   # must end with "/" 
...
sub constructAllFasta {
	...
	foreach my $fafile (sort @fafiles) {
		print ">>> $ORTHOMCL_WORKING_DIR"."$fafile \n"; #NL
		open (FA,$ORTHOMCL_WORKING_DIR.$fafile) or dieWithUnexpectedError("can't open $fafile!");
